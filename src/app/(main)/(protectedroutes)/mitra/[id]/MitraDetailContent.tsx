...
import { FiCheckCircle, FiExternalLink, FiClipboard, FiInfo, FiLock, FiUsers, FiSearch } from "react-icons/fi";
			...
			<div className="relative h-72 sm:h-96 w-full bg-gray-100 z-0 group">
                ...
                {images && images.length > 1 && (
                    <div className="absolute top-1/2 left-0 w-full flex justify-between px-4 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
                        <div className="bg-black/30 p-2 rounded-full text-white backdrop-blur-sm"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg></div>
                        <div className="bg-black/30 p-2 rounded-full text-white backdrop-blur-sm"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></div>
                    </div>
                )}
						...
						<div className="p-6 sm:p-8 bg-gradient-to-br from-gray-50 to-white border-b border-gray-100">
							...
							{loadingApplicants ? (
								<div className="flex flex-col items-center justify-center py-20 gap-4">
									...
									<p className="text-gray-500 font-medium">Memuat data pendaftar...</p>
								</div>
							) : (
