  ...
  useEffect(() => {
    if (bookId) {
      ...
      if (foundBook) {
        ...
        // Increment view count for user books
      ...
      <div className="max-w-[480px] mx-auto pt-[3.8rem] pb-6 px-4">
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="px-5 py-4">
            <h2 className="font-bold text-gray-900 mb-3 text-sm">Informasi Buku</h2>
            <div className="space-y-2">
              <div className="flex">
                <span className="text-xs text-gray-500 w-24 flex-shrink-0">Nama Buku</span>
                <span className="text-xs text-gray-500 mr-2">:</span>
                <span className="text-xs text-gray-800">{book.title}</span>
              </div>
              <div className="flex">
                <span className="text-xs text-gray-500 w-24 flex-shrink-0">Jenjang Buku</span>
                <span className="text-xs text-gray-500 mr-2">:</span>
                <span className="text-xs text-gray-800">{book.jenjang || "-"}</span>
              </div>
              <div className="flex">
                <span className="text-xs text-gray-500 w-24 flex-shrink-0">Halaman</span>
                <span className="text-xs text-gray-500 mr-2">:</span>
                <span className="text-xs text-gray-800">{book.pages ? `${book.pages} halaman` : "-"}</span>
              </div>
              {book.publisher && (
                <div className="flex">
                  <span className="text-xs text-gray-500 w-24 flex-shrink-0">Penerbit</span>
                  <span className="text-xs text-gray-500 mr-2">:</span>
                  <span className="text-xs text-gray-800">{book.publisher}</span>
                </div>
              )}
              {book.year && (
                <div className="flex">
                  <span className="text-xs text-gray-500 w-24 flex-shrink-0">Tahun Terbit</span>
                  <span className="text-xs text-gray-500 mr-2">:</span>
              ...
              {book.isbn && (
                <div className="flex">
                  <span className="text-xs text-gray-500 w-24 flex-shrink-0">ISBN</span>
                  <span className="text-xs text-gray-500 mr-2">:</span>
          ...
          <div className="px-5 pb-4">
            <h2 className="font-bold text-gray-900 mb-2 text-sm">Deskripsi Singkat</h2>
